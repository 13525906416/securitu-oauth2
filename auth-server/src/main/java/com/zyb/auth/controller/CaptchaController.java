...
import com.zyb.auth.ehtity.result.CaptchaResult;
...
import static com.zyb.auth.constant.RedisConstants.*;
...
public class CaptchaController {
    ...
    public Result<String> getSmsCaptcha(@RequestParam("phone") String phone) {
        // 示例项目，固定1234
