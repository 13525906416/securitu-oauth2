...
import com.zyb.auth.authorization.device.DeviceClientAuthenticationConverter;
import com.zyb.auth.authorization.device.DeviceClientAuthenticationProvider;
import com.zyb.auth.authorization.handler.*;
import com.zyb.auth.authorization.sms.SmsCaptchaGrantAuthenticationConverter;
import com.zyb.auth.authorization.sms.SmsCaptchaGrantAuthenticationProvider;
import com.zyb.auth.constant.RedisConstants;
import com.zyb.auth.constant.SecurityConstants;
import com.zyb.auth.repository.RedisSecurityContextRepository;
import com.zyb.auth.support.RedisOperator;
import com.zyb.auth.utils.SecurityUtils;
...
import static com.zyb.auth.constant.NetConstants.NET_IP;
import static com.zyb.auth.constant.SecurityConstants.CONSENT_PAGE_URI;
import static com.zyb.auth.constant.SecurityConstants.DEVICE_ACTIVATE_URI;
...
public class AuthorizationConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        configuration.addAllowedOrigin(NET_IP+":5173");
        // 设置跨域访问可以携带cookie
